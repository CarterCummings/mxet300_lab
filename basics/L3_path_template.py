...
d1 = .25                      # distance in meters of segment 1 in the path
d2 = .5                      # distance in meters of segment 2 in the path
...
motions = [
    [0.25, 0.0, 1.0],            # Motion 1
    [0.0, (pi/6), 3.0],            # Motion 2
    [0.5, 0.0, 2.0],            # Motion 3
    [0.0, (pi/6), 3.0],            # Motion 4
    [0.25, 0.0, 1.0],            # Motion 5
    [0.0, (-pi/6), 3.0],            # Motion 6
    [0.5, 0.0, 2.0],            # Motion 7
    [0.0, (-pi/6), 3.0],            # Motion 8
    [0.25, 0.0, 1.0],            # Motion 9
...
for  count, motion in enumerate(motions):
    ...
    log.tmpFile(motion[0],"xdot.txt")
    log.tmpFile(motion[1],"thetadot.txt")
    log.tmpFile(L1_ina.readVolts(),"voltage.txt")
